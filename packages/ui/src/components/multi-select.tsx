...
interface MultiSelectProps
  ...
  options: {
    ...
    /** Optional color to display alongside the option. */
    color?: string;
  }[];
   ...
   * Optional, defaults to "Sélectionner des options".
   */
  placeholder?: string;
                  ...
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      <Badge
                        ...
                        style={{ animationDuration: `${animation}s`, backgroundColor: option?.color }}
                        variant='secondary'
                      >
